#' @importFrom tidygraph as_tbl_graph tbl_graph activate as_tibble
#' @export
as.matrix.nesmr_tbl_graph <- function(x, value, ...) {
  graph_names <- tidygraph::activate(x, nodes) |> pull(name)
